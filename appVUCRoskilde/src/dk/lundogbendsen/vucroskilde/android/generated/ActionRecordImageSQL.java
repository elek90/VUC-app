...
public class ActionRecordImageSQL extends CommonSQL implements Comparable<ActionRecordImageSQL>
{
  ...
  private static final String ALL_FIELD_NAMES = "ID, PARENTSTEP, IMAGEREF, TIMESTAMP, CHANGESTAMP, DELETESTAMP";
  @Override public String getAllFieldNamesSQL() { return ALL_FIELD_NAMES; }

  private static final String CREATE_TABLE_STATEMENT = "CREATE TABLE ACTIONRECORDIMAGE(ID INTEGER, PARENTSTEP INTEGER NOT NULL, IMAGEREF TEXT NOT NULL, TIMESTAMP TEXT NOT NULL, CHANGESTAMP TEXT NOT NULL, DELETESTAMP TEXT NOT NULL, PRIMARY KEY (ID));";
  ...
  private static final String INSERT_STATEMENT = "INSERT INTO ACTIONRECORDIMAGE(PARENTSTEP, IMAGEREF, TIMESTAMP, CHANGESTAMP, DELETESTAMP, ID) VALUES (?, ?, ?, ?, ?, ?);";
  @Override public String getInsertSQL() { return INSERT_STATEMENT; }

  private static final String UPDATE_STATEMENT = "UPDATE ACTIONRECORDIMAGE SET PARENTSTEP = ?, IMAGEREF = ?, TIMESTAMP = ?, CHANGESTAMP = ?, DELETESTAMP = ? WHERE ID = ?;";
  ...
  private static final String SELECT_BY_ID_STATEMENT = "SELECT PARENTSTEP, IMAGEREF, TIMESTAMP, CHANGESTAMP, DELETESTAMP FROM ACTIONRECORDIMAGE WHERE ID=?;";
