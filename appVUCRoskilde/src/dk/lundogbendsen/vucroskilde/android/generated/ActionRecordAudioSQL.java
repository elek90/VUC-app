...
public class ActionRecordAudioSQL extends CommonSQL implements Comparable<ActionRecordAudioSQL>
{
  ...
  private static final String CREATE_TABLE_STATEMENT = "CREATE TABLE ACTIONRECORDAUDIO(ID INTEGER, PARENTSTEP INTEGER NOT NULL, AUDIOREF TEXT NOT NULL, DESCRIPTION TEXT NOT NULL, TIMESTAMP TEXT NOT NULL, CHANGESTAMP TEXT NOT NULL, DELETESTAMP TEXT NOT NULL, PRIMARY KEY (ID));";
  ...
  private static final String INSERT_STATEMENT = "INSERT INTO ACTIONRECORDAUDIO(PARENTSTEP, AUDIOREF, DESCRIPTION, TIMESTAMP, CHANGESTAMP, DELETESTAMP, ID) VALUES (?, ?, ?, ?, ?, ?, ?);";
  @Override public String getInsertSQL() { return INSERT_STATEMENT; }

  private static final String UPDATE_STATEMENT = "UPDATE ACTIONRECORDAUDIO SET PARENTSTEP = ?, AUDIOREF = ?, DESCRIPTION = ?, TIMESTAMP = ?, CHANGESTAMP = ?, DELETESTAMP = ? WHERE ID = ?;";
  ...
  private static final String SELECT_BY_ID_STATEMENT = "SELECT PARENTSTEP, AUDIOREF, DESCRIPTION, TIMESTAMP, CHANGESTAMP, DELETESTAMP FROM ACTIONRECORDAUDIO WHERE ID=?;";
