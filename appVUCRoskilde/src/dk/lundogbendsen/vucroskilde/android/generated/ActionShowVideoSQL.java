...
public class ActionShowVideoSQL extends CommonSQL implements Comparable<ActionShowVideoSQL>
{
  ...
  private static final String CREATE_TABLE_STATEMENT = "CREATE TABLE ACTIONSHOWVIDEO(ID INTEGER, PARENTSTEP INTEGER NOT NULL, VIDEOREF TEXT NOT NULL, DESCRIPTION TEXT NOT NULL, TIMESTAMP TEXT NOT NULL, CHANGESTAMP TEXT NOT NULL, DELETESTAMP TEXT NOT NULL, PRIMARY KEY (ID));";
  ...
  private static final String INSERT_STATEMENT = "INSERT INTO ACTIONSHOWVIDEO(PARENTSTEP, VIDEOREF, DESCRIPTION, TIMESTAMP, CHANGESTAMP, DELETESTAMP, ID) VALUES (?, ?, ?, ?, ?, ?, ?);";
  @Override public String getInsertSQL() { return INSERT_STATEMENT; }

  private static final String UPDATE_STATEMENT = "UPDATE ACTIONSHOWVIDEO SET PARENTSTEP = ?, VIDEOREF = ?, DESCRIPTION = ?, TIMESTAMP = ?, CHANGESTAMP = ?, DELETESTAMP = ? WHERE ID = ?;";
  ...
  private static final String SELECT_BY_ID_STATEMENT = "SELECT PARENTSTEP, VIDEOREF, DESCRIPTION, TIMESTAMP, CHANGESTAMP, DELETESTAMP FROM ACTIONSHOWVIDEO WHERE ID=?;";
