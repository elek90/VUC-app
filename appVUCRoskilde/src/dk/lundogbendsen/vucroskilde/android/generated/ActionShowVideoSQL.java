...
public class ActionShowVideoSQL extends CommonSQL implements Comparable<ActionShowVideoSQL>
{
  ...
  private static final String INSERT_STATEMENT = "INSERT INTO ACTIONSHOWVIDEO(PARENTSTEP, VIDEOREF_PLACEMENTTYPE, VIDEOREF_PLACEMENTPATH, DESCRIPTION, TIMESTAMP, CHANGESTAMP, DELETESTAMP, ID) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
  @Override public String getInsertSQL() { return INSERT_STATEMENT; }

  private static final String UPDATE_STATEMENT = "UPDATE ACTIONSHOWVIDEO SET PARENTSTEP = ?, VIDEOREF_PLACEMENTTYPE = ?, VIDEOREF_PLACEMENTPATH = ?, DESCRIPTION = ?, TIMESTAMP = ?, CHANGESTAMP = ?, DELETESTAMP = ? WHERE ID = ?;";
  ...
  private static final String SELECT_BY_ID_STATEMENT = "SELECT PARENTSTEP, VIDEOREF_PLACEMENTTYPE, VIDEOREF_PLACEMENTPATH, DESCRIPTION, TIMESTAMP, CHANGESTAMP, DELETESTAMP FROM ACTIONSHOWVIDEO WHERE ID=?;";
