...
public abstract class ActionSendReportViewDelegateRoot extends CommonViewDelegateRoot implements ActionSendReportViewDelegate
{
  protected final ActionSendReportRootActivity activity;
  protected final VUCRoskildeBusinessContext busctx;
  protected final ActionSendReportGUI guictx;
  protected ActionSendReportViewDelegateRoot(final ActionSendReportRootActivity activity, final VUCRoskildeBusinessContext busctx, final ActionSendReportGUI guictx)
  {
    super(activity);
  ...
  @Override
  public abstract void onViewRefreshActionSendReport(final View view, final PayloadRefresh payload);

  @Override
  public abstract void onViewCreateActionSendReport(final View view, final PayloadCreate payload);
