...
public enum StepType
{
  ...
  SHOW_TEXT(ActionShowDescriptionXML.class, R.drawable.ic_info_black_24dp),
  SHOW_PICTURE(ActionShowImageXML.class, R.drawable.ic_photo_black_24dp),
  ...
  RECORD_TEXT(ActionRecordDescriptionXML.class, R.drawable.ic_create_black_24dp),
